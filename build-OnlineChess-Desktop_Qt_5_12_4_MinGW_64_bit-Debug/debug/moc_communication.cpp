...
#include "../../OnlineChess/communication.h"
...
QT_MOC_LITERAL(1, 14, 13), // "readyReadPack"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 10) // "handleRead"

    },
    "Communication\0readyReadPack\0\0handleRead"
};
...
void Communication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Communication::readyReadPack)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Communication::readyReadPack()
{
